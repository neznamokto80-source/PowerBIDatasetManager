...
4. **Нет поддержки нескольких аккаунтов** - одновременно можно работать только с одним аккаунтом Power BI
5. **Ограниченная валидация входных данных** - при настройке расписания
...
4. **Поддержка нескольких аккаунтов** - переключение между разными tenant
5. **Экспорт отчётов** - сохранение статистики обновлений в CSV/Excel
6. **Уведомления** - email/telegram уведомления о статусе обновлений
7. **Docker-образ** - контейнеризация приложения

## Лицензия

Проект распространяется под лицензией MIT. Подробности см. в файле LICENSE (если существует).